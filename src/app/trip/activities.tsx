...
export function Activities({ tripDetails }: Props) {
    ...
    async function getTripActivities() {
        try {
            ...
            const activitiiesToSectionList = activities.map((dayActivity) => ({
                title: {
            ...
            setTripActivities(activitiiesToSectionList)
        } catch (error) {
            console.log(error)
        } finally {
        ...
        <View className="flex-1">
           ...
           {isLoadingActivities ? <Loading /> : (
            ...
            <SectionList 
                ...
                renderSectionHeader={({ section }) => (
                    <View className="w-full">
                        <Text className="text-zinc-50 text-2xl font-semibold py-2d">
            ...
            <Modal
                ...
                subtitle="Todos convidados podem visualizar atividades"
