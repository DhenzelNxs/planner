...
export function Details({ tripId } : { tripId: string }) {
    ...
    const [isCreatingLinkTip, setIsCreatingLinkTrip] = useState(false)
    ...
    return (
        <View className="flex-1 mt-10">
            ...
            <View className="flex-1 border-t vorder-zinc-800 mt-6">
            ...
            >
                <View className="gap-2 mb-3">
                    ...
                    <Button isLoading={isCreatingLinkTip} onPress={handleCreateTripLink}>
                        <Button.Title>
                            Salvar link
                        </Button.Title>
                    </Button>
