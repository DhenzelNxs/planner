...
export default function Index() {
    ...
    function handleAddEmail() {
        ...
        const emailAreadyExists = emailsToInvite.find((email) => email === emailToInvite)
    ...
    return(
        <View className='flex-1 items-center justify-center px-5'>
            <Image source={require("@/assets/logo.png")} className='h-8' 
            resizeMode='contain'/>
            ...
            <Text className='text-zinc-500 font-regular text-center text-base'>
                Ao planejar sua viagem pela plann.er você automaticamente concorda como
                nossos{" "}
